...
win32 {
    # Znajdowanie SFML na komputerze
    ...
    CONFIG(debug, debug|release){
        ...
        copy_dlls.path = $$OUT_PWD/debug
        copy_assets.path = $$OUT_PWD/debug
    } else {
        ...
        copy_dlls.path = $$OUT_PWD/release
        copy_assets.path = $$OUT_PWD/release
    }
